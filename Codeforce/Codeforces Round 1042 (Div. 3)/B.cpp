...
The single line of each test case contains one integer n (2≤n≤2⋅105) — the length of your array.

It is guaranteed that the sum of n over all test cases does not exceed 2⋅10^5.

Output
For each test case, output n integers a1,a2,…,an (−109≤ai≤109), the elements of your array on a new line.
...
Note
In the first test case, because a1⋅a2=−2<0 and a1+a2=1>0, it satisfies the two constraints. In addition, it can be shown that the corresponding b=[1,2] is better than any other good array of length 2.
*/ 
    ...
    while (t--) {
        ...
        for (int i = 1; i <= n; ++i) {
            if (i & 1) {
                ...
                int v = (n % 2 == 0 && i == n) ? 2  : 3; // last even can be 2
                cout << v << ' ';
            }
        }
        cout << '\n';
